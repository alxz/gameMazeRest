...
CREATE TABLE IF NOT EXISTS `tabanswers` (
  ...
  `ansTxtFRA` text COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`ansId`),
  KEY `ansQId` (`ansQId`)
...
CREATE TABLE IF NOT EXISTS `tabquestions` (
  ...
  `qTxtFRA` text COLLATE utf8_general_ci NOT NULL,
  `questionurlFRA` text COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`qId`)
...
(1,'You suspect your computer and the information you are accessing on a database are compromised….you then',0,0,'https://vimeo.com/303102987/5a6b7e9062',N'Vous soupçonnez que votre ordinateur a été piraté et que les informations auxquelles vous accédez par son intermédiaire sont compromises. Aussitôt: ','https://vimeo.com/303103168/5b9c126ea4'),
(2,'You received an email from  a hacker informing you that he took control of your professional data and requesting a ransom. What should you do?',0,0,'https://vimeo.com/303102987/5a6b7e9062',N'Vous avez reçu un courriel d\'un pirate vous informant qu\'il a pris le contrôle de vos données professionnelles et demande une rançon. Que devriez-vous faire?','https://vimeo.com/241087789/508a0530c0'),
(3,'A staff member takes advantage of an open session to snoop into a colleague`s medical record. What is the main violation she/he is incurring? ',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Un membre du personnel profite d\'une session ouverte pour fouiner dans le dossier médical d\'un collègue. Quelle norme professionnelle viole-t-il ?','https://vimeo.com/302833635/4d3a8e7679'),
(4,'You are receiving an email request to click on a link and provide login information for computer maintenance.. What would you do: ',0,0,'https://vimeo.com/303102987/5a6b7e9062',N'Vous recevez un courriel vous demandant de cliquer sur un lien afin d\'effectuer une mise à jour logicielle. La page web s\'affiche alors vous demande de fournir vos identifiants et mot de passe d\’accès au réseau. Que faites-vous ?','https://vimeo.com/241087789/508a0530c0'),
(5,'You are part of the care team of a patient that has an identifiable tattoo on his body. A physician wants to take a picture of him for presenting his case at a conference. You:',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Vous faites partie de l\'équipe de soins d\'un patient qui porte un tatouage particulier susceptible de l\'identifier aisément. En vue d\'une conférence qu\'il doit bientôt donner pour présenter le cas de ce patient, un médecin veut prendre une photo du corps de ce patient au niveau de son tatouage:','https://vimeo.com/302833635/4d3a8e7679'),
(6,'An employee has had to go on sick leave. He looks at the results of his last blood tests on OACIS. What principle would he be infringing?',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Un employé a dû partir en congé maladie. Il accède et regarde les résultats de ses derniers tests sur OACIS. Quel principe enfreint-il?','https://vimeo.com/302833635/4d3a8e7679'),
(7,'Ransomware is a type of malware that requests the client pay a ransom in order to return access to his files. It arrives via e-mail in the form of a url. When you click on it, you accept intrusion. From then on, the ransomware triggers the encryption of  all your files. What would you do in a similar situation:',0,0,'https://vimeo.com/303102987/5a6b7e9062',N'Le rançongiciel est un type de maliciel qui demande au client de payer une rançon afin de lui rendre l\'accès à ses fichiers. Il s\'introduit dans les systèmes informatiques via un courriel qui comprend un lien vers une ressource Internet. Lorsque vous cliquez dessus, vous autorisez l\'intrusion du programme sur votre ordinateur. Dès lors, le rançongiciel commence à chiffrer vos fichiers. Que feriez-vous dans une telle situation ?','https://vimeo.com/241087789/508a0530c0'),
(8,'You received a product offer email What should you do?',0,0,'https://vimeo.com/303102987/5a6b7e9062','Vous avez reçu un courriel commercial. Que devriez-vous faire?','https://vimeo.com/241087789/508a0530c0'),
(9,'Why would you always need to lock or log off your work station?',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Pourquoi auriez-vous toujours besoin de verrouiller ou de vous déconnecter de votre session de travail?','https://vimeo.com/302833635/4d3a8e7679'),
(10,'Which of the following are security acceptable practices to secure the access to your work station:',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Parmi les déclarations suivantes, lesquelles sont des pratiques acceptables en matière de sécurisation des accès à sa session de travail sur son poste informatique:','https://vimeo.com/302833635/4d3a8e7679'),
(11,'Which are the best practices for protecting patient information ',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Quelles sont les meilleures pratiques pour protéger les informations des patients qui sont stockées dans nos bases de données:','https://vimeo.com/302833635/4d3a8e7679'),
(12,'It is possible to welcome visitors without identity cards to our offices, with the following precautions',0,0,'https://vimeo.com/241087789/508a0530c0',N'Il est possible de donner accès à nos bureaux administratifs à des visiteurs, qui ne portent pas de carte d\'identité du CUSM, mais en prenant les précautions suivantes ','https://vimeo.com/244339235/f952cdc98e'),
(13,'Why is it important to wear your ID card',0,0,'https://vimeo.com/241087789/508a0530c0',N'Pourquoi est-il important de porter votre carte d\'identité de façon visible?','https://vimeo.com/244339235/f952cdc98e'),
(14,'Wearing a visible ID card is important',0,0,'https://vimeo.com/241087789/508a0530c0',N'Le port d\'une carte d\'identité est important','https://vimeo.com/244339235/f952cdc98e'),
(15,'What are the requirements for taking pictures of patients:',0,0,'https://vimeo.com/302832544/f3e3e31bbb',N'Quelles sont les exigences pour prendre des photos de patients:','https://vimeo.com/302833635/4d3a8e7679'),
(16,'In public spaces especially elevators, corridors and coffee shops, where there are other people,  it is permitted:',0,0,'https://vimeo.com/241087805/1cc3d8bfff',N'En présence d\'autres personnes (notamment dans les espaces publics comme les ascenseurs, les couloirs et les cafés), il est permis ..','https://vimeo.com/244339094/7b6e05175b'),
(17,'When do you need patient consent for taking pictures of him/her?',0,0,'https://vimeo.com/241087805/1cc3d8bfff',N'Quand avez-vous besoin du consentement du patient pour le prendre en photo ?','https://vimeo.com/244339094/7b6e05175b'),
(18,'Once you have a consistent password you can',0,0,'https://vimeo.com/241087822/b597fe49b5',N'Une fois que vous avez un mot de passe robuste, vous pouvez…','https://vimeo.com/244338953/058a573cca'),
(19,'The best password is the one ',0,0,'https://vimeo.com/241087822/b597fe49b5',N'Un mot de passe fort est un mot de passe :','https://vimeo.com/244338953/058a573cca'),
(20,'When making the choice of a password to protect the  access to a database you will ensure it Is',0,0,'https://vimeo.com/241087822/b597fe49b5',N'Pour sécuriser votre accès à une base de données, vous pouvez choisir comme mot de passe:','https://vimeo.com/244338953/058a573cca'),
(21,'If you want to choose a password that will be difficult to discover by people with bad intentions, you will make sure that:',0,0,'https://vimeo.com/241087822/b597fe49b5',N'Si vous faites le choix d\’un mot de passe difficile à découvrir par des personnes mal intentionnées, vous vous assurez que:','https://vimeo.com/244338953/058a573cca'),
(22,'Passwords are like toothbrushes.. so you should',0,0,'https://vimeo.com/241087842/de1530f6eb',N'Les mots de passe sont comme les brosses à dents.','https://vimeo.com/244338734/83c80dd070'),
(23,'You are a patient at the hospital and you are in the cafeteria. Sitting next to you 2 members of the staff are talking about a patient currently in the  operated room, who is actually a renown politician. You:',0,0,'https://vimeo.com/241087805/1cc3d8bfff',N'Vous êtes patient à l\'hôpital et vous êtes à la cafétéria. Assis à côté de vous, deux membres du personnel dicutent d\'un patient présentement en salle d\'opérations, qui s\'avère être unpoliticien de renom. Que faites-vous ?','https://vimeo.com/244339094/7b6e05175b'),
(24,'A person arrives for a meeting in the floor of the office building and is not wearing an ID card. If you opened the door for him/her what would you ask?',0,0,'https://vimeo.com/241087789/508a0530c0',N'Une personne arrive pour une réunion à l\'étage de l\'immeuble de bureaux et ne porte pas de carte d\'identité. Vous lui ouvrez la porte, et lui demandez','https://vimeo.com/244339235/f952cdc98e'),
(25,'There is an incident at the hospital and the press is covering it. A journalist wanders around the hospital to try to gather additional information t. You notice this gentleman has no ID card and …',0,0,'https://vimeo.com/241087789/508a0530c0',N'Il y a un incident à l\'hôpital et la presse le couvre. Un journaliste se promène dans l\'hôpital, peut être il cherche  des informations supplémentaires. Vous remarquez qu\’il ne porte pas de carte donc vous…','https://vimeo.com/244339235/f952cdc98e'),
(26,'You are a medical secretary, and an intern has been hired to work with you during a period of heavy workload. Which of the following is inappropriate?',0,0,'https://vimeo.com/241087842/de1530f6eb',N'Vous êtes secrétaire médical, à l\'accueil d\'une clinique recevant un grand nombre de patients. Vous connaissez présentement une intense période de surcharge de travail. Aussi a-t-on embauché temporairement une stagiaire pour vous assister durant quelques semaines. Lequel des énoncés suivants est inapproprié ?','https://vimeo.com/244338734/83c80dd070'),
(27,'How would you evaluate the risk of sharing passwords:',0,0,'https://vimeo.com/241087842/de1530f6eb',N'Comment évalueriez-vous le risque de partager des mots de passe:','https://vimeo.com/244338734/83c80dd070');
