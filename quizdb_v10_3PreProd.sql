...
-- Generation Time: Dec 13, 2019 at 10:17 PM
...
(2, 'You call Help Desk at 48484 to inform them.', 1, 1, 'Vous appelez le soutien  informatique au 48484 pour leurs informer'),
...
(18, 'You remind him to ask the patient for written consent prior to taking pictures and file it in his medical file', 5, 1, 'Vous lui rappelez de demander le consentement écrit au patient avant de prendre des photos et le classez dans son dossier médical'),
...
(34, 'It is necessary to prevent others to snoop into your files', 9, 1, 'C\'est nécessaire, pour empêcher les autres de fouiner dans vos fichiers'),
...
(41, 'To use robust passwords', 11, 0, 'Utiliser des mots de passe robustes.'),
...
(51, 'So that other staff may consider you are presumably entitled to circulate in the premises', 13, 1, 'Pour que les autres membres du personnel sachent que vous avez le droit de circuler dans des locaux du CUSM'),
...
(69, 'Use it across multiple sites ', 18, 0, 'L\'utiliser sur plusieurs sites'),
...
(74, 'Built with a word where \'E\' is replaced by \'3\' ', 19, 0, 'Qui est constitué d\'un mot dans lequel les \'E\' sont remplacés par des \'3\' '),
...
(88, 'None of these statements is correct', 22, 1, 'Aucun énoncé n’est correct'),
...
(101, 'You give the intern  your login information(user ID and password)  so that she can access information ', 26, 0, 'Vous donnez vos informations de connexion (identifiant et mot de passe) à la stagiaire pour qu\'elle puisse accéder à vos fichiers '),
...
(103, 'You copy your login information on a post-it and stick it on the monitor in an open office so that the intern can work while you are away  ', 26, 0, 'Vous inscrivez vos informations de connexion (identifiant et mot de passe) sur un papillon adhésif que vous collez sur votre poste de travail en aire ouverte pour que la stagiaire puisse travailler sur vos dossiers durant votre absence'),
(104, 'All of these statements are correct', 26, 1, 'Tous les énoncés sont corrects.'),
...
(7, 'Ransomware -a malware that requests a client to pay a ransom in order to return access to his files- is introduced  via an email that includes a link to a malicious site. When you click on it, you allow the program`s intrusion. From then on, the ransomware triggers the encryption of  all your files. What would you do in such  situation?', 0, 0, 'https://player.vimeo.com/video/303102987', 'Le rançongiciel -maliciel qui demande au client de payer une rançon afin de lui rendre l\'accès à ses fichiers-  s\'introduit via un courriel qui comprend un lien vers une ressource Internet. En cliquant  sur le lien, vous autorisez l\'intrusion. Dès lors, le rançongiciel commence à chiffrer vos fichiers. Que feriez-vous dans une telle situation', 'https://player.vimeo.com/video/241087789'),
...
(9, 'Why would you always need to lock or log off your work station?', 0, 0, 'https://player.vimeo.com/video/302832544', 'Pourquoi faut-il toujours verrouiller son poste de travail ou fermer sa session de travail?', 'https://player.vimeo.com/video/302833635'),
...
(18, 'Once you have a consistent password you can', 0, 0, 'https://player.vimeo.com/video/241087822', 'Une fois que vous avez un mot de passe robuste, vous pouvez', 'https://player.vimeo.com/video/244338953'),
